	 	...
	 	<div class="row">
	 		<div class="col-sm-12">
 					<div class="jumbotron">
 						...
 						<p class="lead">Please enter the account's username to alter. Thanks you!</p>
 						<hr class="m-y-md">
 						<p></p>
 					</div>		
	 		</div>
	 ...
	 <div class="container">
		<div class="row">
			<div class="col-sm-6 offset-3">
				<form class="d-flex" action="suataikhoan.php" method="POST" enctype="multipart">
				...
				if ($result->num_rows > 0) {
					...
					while($row = $result->fetch_assoc()) {
						?>
						<form action="../../controllers/xulysuatk.php" method="POST" enctype="multipart/form-data">
							...
							<fieldset class="form-group">
								...
								<input name="uname" type="text" class="form-control"  value="<?= $row['username'] ?>" readonly>
							</fieldset>

							<fieldset class="form-group">
								<label for="exampleInputPassword1">Password:</label>
								<input name="psw" placeholder="Nhập password..." type="password" class="form-control" >
							</fieldset>

							<fieldset class="form-group">
								<label for="exampleInputPassword1">Password:</label>
								<input name="confirm-psw" placeholder="Xác nhận password..." type="password" class="form-control">
							</fieldset>
