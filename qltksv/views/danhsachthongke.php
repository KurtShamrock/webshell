...
<body>
	...
	<div class="container">
		<div class="row">
			<div class="jumbotron">
				<p></p>
				<h1 class="display-3" align="CENTER">DANH SÁCH THỐNG KÊ</h1>
				<hr class="m-y-md">
				<p></p>
			</div>
		</div> 
		...
		<div class="container">
			<div class="col-sm-12">
				<table class="table table-bordered table-inverse table-hover">
					...
					<tbody align="CENTER">
						<?php 
							$sql = "select s.id,c.classname,s.studentcode,s.name,s.hometown,s.phone,a.username from student s left join class c on c.id=s.classid left join account a on a.studentcode=s.studentcode;";
		...
		<br />
    <form method="post" action="../services/export.php?option=sv">
