...
<body>
	...
	<div class="container">
		<div class="row">
			<div class="jumbotron">
				<p></p>
				<h1 class="display-3" align="CENTER">DANH SÁCH THỐNG KÊ THEO TÀI KHOẢN</h1>
				<hr class="m-y-md">
				<p></p>
			</div>
		</div> 
		...
		<div class="container">
			<div class="col-sm-12">
				<table class="table table-bordered table-inverse table-hover">
					...
					<tbody align="CENTER">
						<?php 
						$sql = "select a.id,c.classname,s.studentcode,s.name,s.hometown,s.phone,a.username from account a left join student s on a.studentcode=s.studentcode left join class c on c.id=s.classid;";
		...
		<br />
    <form method="post" action="../services/export.php?option=tk">
